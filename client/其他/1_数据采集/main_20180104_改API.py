        ...
        for service in services:
            ...
            if service =='system':
                ...
                if services[service]['time_format'] == 'period':
                    ...
                    sched.add_job(Kettle_monitor(host_obj, services[service]).check_process, 'interval', seconds=int(services[service]['monitor_process']))
                elif services[service]['time_format'] == 'time':
                    pass
                print services[service]
                # sched.add_job(Kettle_monitor(host_obj,services[service]).check_process, 'interval', seconds=3)
